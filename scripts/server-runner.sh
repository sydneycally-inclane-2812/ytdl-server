...
# Includes: setting up environment variables, activating the virtual environment, and running the FastAPI server + Celery worker as ytdl-server and ytdl-celery users respectively.
